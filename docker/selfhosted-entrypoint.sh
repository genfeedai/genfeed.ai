...
export GENFEEDAI_API_PUBLIC_URL=${GENFEEDAI_API_PUBLIC_URL:-$GENFEEDAI_API_URL}
...
export GENFEEDAI_MCP_PUBLIC_URL=${GENFEEDAI_MCP_PUBLIC_URL:-http://localhost:3014/mcp}
...
if [ "$BETTER_AUTH_ENABLED" = "false" ]; then
  ...
  export BETTER_AUTH_URL=${BETTER_AUTH_URL:-$GENFEEDAI_API_PUBLIC_URL}
