# Agent setup for `genfeed-ai`

This is a deepsec scanning workspace. Project `genfeed-ai` was just registered
(target: `..`). Setup is incomplete — `data/genfeed-ai/INFO.md`
...
2. **Fill in `data/genfeed-ai/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id genfeed-ai
pnpm deepsec process --project-id genfeed-ai
```
