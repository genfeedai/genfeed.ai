packages: @genfeedai/interfaces @genfeedai/agent @genfeedai/serializers @genfeedai/actions @genfeedai/constants @genfeedai/client @genfeedai/services @genfeedai/prisma
