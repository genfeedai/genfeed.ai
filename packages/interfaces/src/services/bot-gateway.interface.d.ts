import type { BotCommandType, BotInteractionType, BotResponseType, CredentialPlatform } from '@genfeedai/enums';
/**
...
export interface IBotPlatformAdapter {
     ...
     */
    validateSignature(body: Buffer | string, signature: string, timestamp?: string): boolean | Promise<boolean>;
    /**
     ...
     */
    buildImmediateResponse(type: BotResponseType, message?: string): Record<string, unknown>;
    /**
     * Send a follow-up text message
     */
    sendFollowupMessage(applicationId: string, interactionToken: string, message: string): Promise<void>;
    /**
     * Send media (image/video) as a follow-up
     */
    sendFollowupMedia(applicationId: string, interactionToken: string, url: string, type: 'image' | 'video', caption?: string): Promise<void>;
}
/**
...
//# sourceMappingURL=bot-gateway.interface.d.ts.map