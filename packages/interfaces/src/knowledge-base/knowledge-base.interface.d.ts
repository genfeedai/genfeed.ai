import type { KnowledgeBaseCategory, KnowledgeBaseScope, KnowledgeBaseStatus, Platform } from '@genfeedai/enums';
...
export interface ISocialAccount {
    id: string;
    platform: Platform.INSTAGRAM | Platform.TWITTER | Platform.FACEBOOK | Platform.LINKEDIN | Platform.TIKTOK | Platform.YOUTUBE;
    handle: string;
    url: string;
    verified: boolean;
...
export type KnowledgeBaseType = 'brand-voice' | 'content-library' | 'audience-data' | 'product-info' | 'campaign-data' | 'custom';
...
export type SourceType = 'document' | 'website' | 'social-account' | 'analytics-data' | 'manual-entry' | 'api';
...
//# sourceMappingURL=knowledge-base.interface.d.ts.map