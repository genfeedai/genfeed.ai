 ...
 */
export type PWAAppNameKey = 'app' | 'studio' | 'workflows' | 'manager' | 'publisher' | 'analytics' | 'automation' | 'dashboard' | 'settings' | 'marketplace';
/**
...
//# sourceMappingURL=pwa.interface.d.ts.map