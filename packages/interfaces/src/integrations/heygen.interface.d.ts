...
interface IHeyGenVoicesAttributes extends IHeyGenCollectionAttributes<'voices'> {
    voices: IHeyGenMediaItem[];
}
interface IHeyGenAvatarsAttributes extends IHeyGenCollectionAttributes<'avatars'> {
...
export {};
//# sourceMappingURL=heygen.interface.d.ts.map