...
export interface IAdsAdapter {
    ...
    getCampaignInsights(ctx: AdsAdapterContext, campaignId: string, params?: {
        datePreset?: string;
        timeRange?: {
            since: string;
            until: string;
    ...
    createCampaign(ctx: AdsAdapterContext, input: CreateCampaignInput): Promise<UnifiedCampaign>;
    updateCampaign(ctx: AdsAdapterContext, campaignId: string, input: UpdateCampaignInput): Promise<UnifiedCampaign>;
    pauseCampaign(ctx: AdsAdapterContext, campaignId: string): Promise<void>;
    listAdSets(ctx: AdsAdapterContext, campaignId: string): Promise<UnifiedAdSet[]>;
    createAdSet(ctx: AdsAdapterContext, input: CreateAdSetInput): Promise<UnifiedAdSet>;
    ...
    getTopPerformers(ctx: AdsAdapterContext, params?: {
        metric?: string;
        limit?: number;
        datePreset?: string;
    }): Promise<Array<{
...
//# sourceMappingURL=ads-gateway.interface.d.ts.map