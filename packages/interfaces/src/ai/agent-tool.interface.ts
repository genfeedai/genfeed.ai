...
export enum AgentToolName {
  ...
  CREATE_INSTAGRAM_REMIX_WORKFLOW = 'create_instagram_remix_workflow',
  GENERATE_AD_PACK = 'generate_ad_pack',
  GET_INSTAGRAM_INSPIRATION_DETAIL = 'get_instagram_inspiration_detail',
  PREPARE_AD_LAUNCH_REVIEW = 'prepare_ad_launch_review',
  LIST_INSTAGRAM_INSPIRATION = 'list_instagram_inspiration',
