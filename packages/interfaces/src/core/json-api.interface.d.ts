 ...
 */
export type JsonApiResult<T = unknown> = JsonApiSingleResponse<T> | JsonApiCollectionResponse<T>;
/**
 ...
 */
export type JsonApiResponse<T = unknown> = JsonApiSingleResponse<T> | JsonApiCollectionResponse<T> | JsonApiErrorResponse;
