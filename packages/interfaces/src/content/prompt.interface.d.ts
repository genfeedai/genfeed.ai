import type { AssetScope, ImageFormat, IngredientFormat, TrainingCategory, UpscaleFactor, VideoResolution } from '@genfeedai/enums';
import type { IBaseEntity, IElementCamera, IElementMood, IElementStyle, IFontFamily, IIngredient, ITag } from '../index';
...
export interface IEditFormData {
    ...
    enhanceModel?: 'Standard V2' | 'Low Resolution V2' | 'CGI' | 'High Fidelity V2' | 'Text Refine';
