...
export type TemplateCategory = 'social-media' | 'marketing' | 'ecommerce' | 'education' | 'entertainment' | 'news' | 'personal-brand' | 'corporate' | 'nonprofit';
export type TemplateIndustry = 'technology' | 'finance' | 'healthcare' | 'retail' | 'food' | 'fashion' | 'travel' | 'fitness' | 'real-estate' | 'automotive' | 'general';
export type TemplateType = 'video' | 'image' | 'caption' | 'article' | 'campaign' | 'workflow';
...
export type VariableType = 'text' | 'number' | 'boolean' | 'select' | 'multiselect' | 'color' | 'image' | 'video' | 'date' | 'url';
...
//# sourceMappingURL=template-ui.interface.d.ts.map