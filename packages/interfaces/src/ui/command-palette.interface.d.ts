...
export type CommandCategory = 'actions' | 'administration' | 'automation' | 'configuration' | 'content' | 'crm' | 'darkroom' | 'generation' | 'help' | 'navigation' | 'recent' | 'search' | 'settings';
...
//# sourceMappingURL=command-palette.interface.d.ts.map