...
import type { IActivity, IAnalytics, IBrand, ICreditsBreakdown, IOrganizationSetting, ISubscription } from '../index';
...
export interface UseOrganizationReturn {
    ...
    isLoading: boolean;
    error: string | null;
    updateSettings: (key: keyof IOrganizationSetting, value: boolean | number | string) => Promise<void>;
    refresh: () => Promise<void>;
}
