...
describe('ConfigService', () => {
  ...
  beforeEach(() => {
    ...
    env.STRIPE_PRICE_PAYG = 'price_testpayg';
    env.STRIPE_PRICE_SUBSCRIPTION_PRO_MONTHLY = 'price_testpro';
    env.STRIPE_PRICE_SUBSCRIPTION_PRO_YEARLY = 'price_testproyearly';
    env.STRIPE_PRICE_SUBSCRIPTION_SCALE_MONTHLY = 'price_testscale';
    env.STRIPE_PRICE_SUBSCRIPTION_ENTERPRISE_MONTHLY = 'price_testenterprise';
