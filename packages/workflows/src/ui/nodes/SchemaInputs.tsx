    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex items-center gap-2 nodrag">
        ...
        <Input
          ...
          className="nodrag nopan w-16 h-7 border border-input bg-background px-2 text-xs text-center shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Input
        ...
        className="nodrag nopan w-full h-8 border border-input bg-background px-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      />
    </div>
  );
}
