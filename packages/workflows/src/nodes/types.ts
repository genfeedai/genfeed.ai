import type { BaseNodeData as CoreBaseNodeData } from '@genfeedai/contracts/types/nodes';
import * as CoreNodeTypes from '@genfeedai/contracts/types/nodes';
...
export type { NodeType as CoreNodeType } from '@genfeedai/contracts/types/nodes';
