  ...
  public getPredefinedModels(): Partial<IModel>[] {
    return [
      ...
      },
      {
        ...
        costTier: CostTier.MEDIUM,
        description:
          'Google Nano Banana 2 — next-gen image generation via fal.ai',
        isActive: true,
        isDefault: false,
        key: MODEL_KEYS.FAL_NANO_BANANA_2,
        label: 'Nano Banana 2',
        minCost: 0.001,
        pricingType: PricingType.PER_REQUEST,
        provider: this.provider,
      ...
      },
      {
        ...
        costPerUnit: 0.01,
        costTier: CostTier.MEDIUM,
        description: 'FLUX 2 Pro — professional image generation via fal.ai',
        isActive: true,
        isDefault: false,
        key: MODEL_KEYS.FAL_FLUX_2_PRO,
        label: 'FLUX 2 Pro',
        minCost: 0.001,
        pricingType: PricingType.PER_REQUEST,
        provider: this.provider,
      ...
      {
        capabilities: ['Text Prompt', 'High Quality', 'Design'],
        category: ModelCategory.IMAGE,
        cost: 0.02,
        costPerUnit: 0.02,
        costTier: CostTier.MEDIUM,
        description:
          'Recraft V4 Pro — design-focused image generation via fal.ai',
        isActive: true,
        isDefault: false,
        key: MODEL_KEYS.FAL_RECRAFT_V4_PRO,
      ...
      },
      {
        ...
        costTier: CostTier.MEDIUM,
        description:
          'OpenAI GPT Image 2 — multimodal image generation via fal.ai',
        isActive: true,
        isDefault: false,
        key: MODEL_KEYS.FAL_GPT_IMAGE_2,
        label: 'GPT Image 2',
        minCost: 0.001,
        pricingType: PricingType.PER_REQUEST,
        provider: this.provider,
      ...
      },
      {
        ...
        costPerUnit: 0.2,
        costTier: CostTier.HIGH,
        description: 'Kling V3 Pro — high-quality video generation via fal.ai',
        isActive: true,
        isDefault: false,
        key: MODEL_KEYS.FAL_KLING_VIDEO_V3_PRO,
        label: 'Kling V3 Pro',
        minCost: 0.001,
        pricingType: PricingType.PER_REQUEST,
        provider: this.provider,
      ...
      },
      {
        ...
        costTier: CostTier.HIGH,
        description:
          'Google Veo 3.1 — state-of-the-art video generation via fal.ai',
        isActive: true,
        isDefault: false,
        key: MODEL_KEYS.FAL_VEO_3_1,
        label: 'Veo 3.1',
        minCost: 0.001,
        pricingType: PricingType.PER_REQUEST,
        provider: this.provider,
      ...
      },
      {
        ...
        costPerUnit: 0.1,
        costTier: CostTier.HIGH,
        description: 'PixVerse V6 — versatile video generation via fal.ai',
        isActive: true,
        isDefault: false,
        key: MODEL_KEYS.FAL_PIXVERSE_V6,
        label: 'PixVerse V6',
        minCost: 0.001,
        pricingType: PricingType.PER_REQUEST,
        provider: this.provider,
