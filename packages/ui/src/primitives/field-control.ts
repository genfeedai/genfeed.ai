export const fieldControlClassName =
  'ship-ui flex h-8 w-full min-w-0 rounded-lg border border-border bg-tertiary px-3 py-1.5 text-sm text-primary transition-[color,box-shadow,border-color,background-color] duration-200 placeholder:text-muted focus-visible:outline-none focus-visible:border-border-strong disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50';
