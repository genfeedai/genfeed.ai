...
export default function MenuItem({
  ...
  const iconWrapperClass = cn(
    ...
    isIconVariant
      ? isHorizontalLayout
        ...
        : [
            'gen-shell-surface h-11 w-11 rounded-md text-foreground/78',
  ...
  const baseClasses = isIconVariant
    ? isHorizontalLayout
      ? cn(
          'group relative flex h-10 w-full flex-row items-center gap-3 rounded-md px-3.5 py-2 text-left transition-[background-color,color,transform] duration-200',
    ...
    : 'group flex h-10 items-center gap-3 rounded-md px-3.5 py-2 text-left transition-[background-color,color] duration-200';
