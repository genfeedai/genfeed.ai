...
type UseModalGenerateIllustrationParams = Pick<
  ModalGenerateIllustrationProps,
  'isOpen' | 'openKey' | 'initialPrompt' | 'platform' | 'onConfirm' | 'onClose'
>;

export function useModalGenerateIllustration({
  isOpen,
  openKey,
  initialPrompt = '',
  platform,
  onConfirm,
  onClose,
}: UseModalGenerateIllustrationParams) {
