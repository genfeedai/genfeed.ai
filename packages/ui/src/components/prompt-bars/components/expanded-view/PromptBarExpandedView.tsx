...
const PromptBarExpandedView = memo(function PromptBarExpandedView() {
  ...
  const essentials = (
    <PromptBarEssentials
      ...
      extraExtensions={ctx.extraExtensions}
      onDocumentChange={ctx.onDocumentChange}
    ...
    >
      ...
      >
        <div className="flex h-full items-center justify-center">
          <div
            className={
              'rounded-2xl border border-primary/30 bg-black/50 px-4 py-3 text-center backdrop-blur-sm' /* design-system-allow-content-color -- drop-target scrim */
            }
          >
            <p
              className={
                'text-sm font-medium text-white' /* design-system-allow-content-color -- drop-target scrim */
              }
            >
              {dropLabel}
            </p>
            <p
              className={
                'mt-1 text-xs text-white/60' /* design-system-allow-content-color -- drop-target scrim */
              }
            >
