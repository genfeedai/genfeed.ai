...
export default function WorkspaceSwitcherSection({
  ...
  return (
    <div className="border-b border-foreground/[0.06] px-1 pb-2 pt-1 last:border-b-0">
            ...
            <Button
              ...
              className={cn(
                ...
                item.isActive
                  ...
                  : 'text-foreground/68 hover:bg-foreground/[0.035] hover:text-foreground',
              )}
            >
              {item.imageUrl ? (
                ...
                <div
                  className={cn(
                    ...
                    item.isActive
                      ...
                      : 'bg-foreground/[0.08] text-foreground/58',
                  )}
                >
