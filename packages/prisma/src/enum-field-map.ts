...
export const PRISMA_MODEL_METADATA: Readonly<Record<string, ModelFieldMeta>> = {
  ...
  BrandOsPublication: {
    ...
    listFields: ['publishedRevisionIds'],
    enumFields: {},
    relationIdFields: {
      brand: 'brandId',
      organization: 'organizationId',
  ...
  BrandOsRevision: {
    ...
    listFields: ['publications'],
    enumFields: {
      status: { enumType: 'BrandOsRevisionStatus', isRequired: true },
    },
    relationIdFields: {
  ...
  EmailSuppression: {
    allFields: ['createdAt', 'reason', 'recipientHash'],
    listFields: [],
    enumFields: {},
    relationIdFields: {},
  },
  ...
  KnowledgeSource: {
    ...
    listFields: ['captureRequests', 'memberships', 'refreshRuns', 'versions'],
    enumFields: {
      kind: { enumType: 'KnowledgeSourceKind', isRequired: true },
      purpose: { enumType: 'KnowledgeSourcePurpose', isRequired: true },
      syncState: { enumType: 'KnowledgeSourceSyncState', isRequired: false },
    },
    relationIdFields: {
      brand: 'brandId',
      organization: 'organizationId',
  ...
  KnowledgeSourceRefreshRun: {
    ...
    listFields: [],
    enumFields: {
      outcome: { enumType: 'KnowledgeRefreshRunOutcome', isRequired: false },
      status: { enumType: 'KnowledgeRefreshRunStatus', isRequired: true },
    },
    relationIdFields: {
  ...
  KnowledgeSourceVersion: {
    ...
    listFields: ['candidateRefreshRuns', 'chunks', 'supersedesVersions'],
    enumFields: {
      processingState: {
  ...
  LiveSession: {
    ...
    listFields: [],
    enumFields: {
      status: { enumType: 'LiveSessionStatus', isRequired: true },
    },
    relationIdFields: {
      organization: 'organizationId',
    },
  ...
  Organization: {
    ...
    listFields: [
      ...
      'insights',
      'invitations',
      'knowledgeCaptureRequests',
      'knowledgeSourceRefreshRuns',
      'knowledgeSources',
      'knowledgeSpaces',
      'leads',
      'listeningEvidence',
  ...
  OutlierBaselineSnapshot: {
    ...
    listFields: ['contributorIds', 'performances'],
    enumFields: {},
    relationIdFields: {},
  },
  ...
  SkillGrant: {
    ...
    relationIdFields: {
      ...
      recipientBrand: 'recipientBrandId',
  ...
  SkillMigrationFinding: {
    allFields: ['createdAt', 'detail', 'id', 'kind'],
    listFields: [],
    enumFields: {},
    relationIdFields: {},
  },
  ...
  SystemNotificationSettings: {
    allFields: ['enabled', 'id', 'updatedAt'],
    listFields: ['eventTypes'],
    enumFields: {},
    relationIdFields: {},
  },
  Tag: {
  ...
  User: {
    ...
    listFields: [
      ...
      'posts',
      'profiles',
      'promotedAgentMemories',
      'promotedWorkflowArtifacts',
      'prompts',
      'publishApprovals',
      'publishedBrandOsPublications',
      'referralCodes',
      'replyBotConfigs',
      'revokedBrandOsPublications',
      'rssFeedItems',
      'rssSources',
      'savedAds',
      'sessions',
