...
describe('Serializer Attributes', () => {
  ...
  describe('listingAttributes', () => {
    it('should be a non-empty array of strings', () => {
      ...
      for (const attr of listingAttributes) expect(typeof attr).toBe('string');
    });
  });
  ...
  describe('sellerAttributes', () => {
    it('should be a non-empty array of strings', () => {
      ...
      for (const attr of sellerAttributes) expect(typeof attr).toBe('string');
    });
  });
  ...
  describe('purchaseAttributes', () => {
    it('should be a non-empty array of strings', () => {
      ...
      for (const attr of purchaseAttributes) expect(typeof attr).toBe('string');
    });
  });
