  ...
  return (
    <>
      ...
      <Button
        ...
        withWrapper={false}
        onClick={toggleOpen}
        className="fixed bottom-6 right-6 z-50 flex size-12 items-center justify-center rounded-md bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-105"
