    ...
    <div className="my-2 overflow-hidden border border-border bg-background">
      ...
      <div className="p-4">
        <div className="mb-3 flex items-center gap-2">
          <Paintbrush className="size-5 text-violet-500" />
        ...
        {/* Editor type badge */}
        <div className="mb-3">
          <span className="rounded-full bg-violet-50 px-2 py-0.5 text-2xs font-medium text-violet-600 dark:bg-violet-900/30 dark:text-violet-400">
            {editorType}
          </span>
        </div>
