...
export function AgentConversationSkeleton({
  ...
  // Full-width scroll (window-edge scrollbar); shared track with composer.
  return (
    <div
    ...
    >
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto flex w-full min-w-0 max-w-4xl flex-col px-3 py-5 pb-36 sm:px-4 md:pb-40">
