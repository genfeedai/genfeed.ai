...
export const KNOWLEDGE_REFRESH_SCHEDULE_CRON = '*/15 * * * *';
export const KNOWLEDGE_MEDIA_MAX_BYTES = 25_000_000;
export const KNOWLEDGE_TRANSCRIPT_TIMEOUT_MS = 30_000;
export const KNOWLEDGE_TRANSCRIPT_GENERATION_LEASE_MS = 10 * 60 * 1000;
