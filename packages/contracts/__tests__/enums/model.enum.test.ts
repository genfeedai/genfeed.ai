...
import { MODEL_KEYS } from '../../src/constants';
import {
  CostTier,
  ModelCategory,
  ModelProvider,
  ...
  QualityTier,
  SpeedTier,
} from '../../src/enums/model.enum';

describe('model.enum', () => {
  describe('ModelKey', () => {
    it('should have 127 members', () => {
      expect(Object.values(MODEL_KEYS)).toHaveLength(127);
    });
    ...
    it('should have correct values', () => {
      ...
      expect(MODEL_KEYS.FAL_MINIMAX_H3_MAX_DIRECTOR).toBe(
