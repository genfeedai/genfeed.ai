import { createSampleGenerationWebhookPayload } from '@api-types/contracts/generation-webhook-events.contract';
...
import { createSampleWorkflowWebhookPayload } from '@api-types/contracts/workflow-webhook-events.contract';
