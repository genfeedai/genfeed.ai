...
const WORKFLOW_ACTIONS = [
  ...
  [
    ...
    'Daily draft',
    'Draft a post from the selected source.',
    'ai',
    'Sparkles',
  ],
  [
    ...
    'Evaluate draft',
    'Score the draft and hold weak copy.',
    'processing',
    'Check',
  ],
  [
  ...
  ['analyticsFeedback', 'Analytics', 'Performance stats.', 'input', 'Eye'],
  [
  ...
  ['brand', 'Brand', 'Colors, voice, and models.', 'input', 'Layers'],
  ['brandAsset', 'Brand asset', 'Logo or reference file.', 'input', 'Image'],
  [
    'brandContext',
    'Brand context',
    'Combined brand settings.',
    'input',
    'Layers',
  ],
  ...
  [
    'separateDialogue',
    'Separate Dialogue',
    'Extracts background audio from finished media. Review the background stem before mixing replacement speech.',
    'processing',
    'AudioLines',
  ],
  [
  ...
  [
    'localizeSpeech',
    'Localize Speech',
    'Transcribes video, translates timed dialogue and generates replacement speech.',
    'ai',
    'AudioLines',
  ],
  [
