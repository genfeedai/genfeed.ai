...
export const CURATED_ACTION_CATALOG = [
  ...
  { name: 'archive_knowledge_source', surfaces: ['agent', 'mcp'] },
  { name: 'assign_knowledge_purpose', surfaces: ['agent', 'mcp'] },
  { name: 'assign_social_conversation', surfaces: ['mcp'] },
  { name: 'batch_approve_reject', surfaces: ['agent'] },
  { name: 'capture_knowledge', surfaces: ['agent', 'mcp'] },
  ...
  { name: 'list_knowledge_sources', surfaces: ['agent', 'mcp'] },
  ...
  { name: 'read_knowledge_source', surfaces: ['agent', 'mcp'] },
  { name: 'reframe_image', surfaces: ['agent', 'mcp'] },
  { name: 'reject_social_draft', surfaces: ['mcp'] },
  { name: 'rename_brand', surfaces: ['agent'] },
  { name: 'request_input', surfaces: ['agent'] },
  { name: 'present_work_object', surfaces: ['agent'] },
  { name: 'ingest_source_media', surfaces: ['agent'] },
  ...
  { name: 'retry_knowledge_ingestion', surfaces: ['agent', 'mcp'] },
  ...
  { name: 'search_knowledge', surfaces: ['agent', 'mcp'] },
