...
const CLIENT_SERIALIZERS_MOCK = path.resolve(__dirname, '../services/__mocks__/client-serializers.mock.ts');
const CLIENT_MODELS_MOCK = path.resolve(__dirname, './tests/__mocks__/client-models.mock.ts');
const XYFLOW_REACT_MOCK = path.resolve(__dirname, './tests/__mocks__/xyflow-react.ts');
    ...
    resolve: {
        alias: [
            ...
            },
            {
                ...
                replacement: path.resolve(__dirname, './tests/__mocks__/logger.service.ts'),
            },
            {
                find: '@services',
                replacement: path.resolve(__dirname, '../services'),
