export const APP_ROUTES = {
  ...
  ADMIN: {
    ...
    DARKROOM: {
      CHARACTERS: '/admin/darkroom/characters',
      GALLERY: '/admin/darkroom/gallery',
      GENERATE: '/admin/darkroom/generate',
      INFRASTRUCTURE: '/admin/darkroom/infrastructure',
      LIP_SYNC: '/admin/darkroom/lip-sync',
      PIPELINE: '/admin/darkroom/pipeline',
      TRAINING: '/admin/darkroom/training',
      VOICES: '/admin/darkroom/voices',
    },
    LIBRARY: {
