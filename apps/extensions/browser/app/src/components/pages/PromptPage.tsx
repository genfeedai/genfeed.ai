  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <Textarea
            ...
            className="w-full px-3 py-2 border border-zinc-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
            rows={4}
      ...
      <div className="border-t pt-4">
        <h4 className="text-sm font-medium text-zinc-700 mb-2">Tips:</h4>
