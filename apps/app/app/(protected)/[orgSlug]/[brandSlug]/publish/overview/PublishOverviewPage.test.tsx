...
vi.mock('@ui/overview/OverviewLayout', () => ({
  default: ({
    ...
    <main>
      {header}
      <section aria-label="Publish destinations">
        {cards.map((card) => (
          <article key={card.id}>
            <h2>{card.label}</h2>
