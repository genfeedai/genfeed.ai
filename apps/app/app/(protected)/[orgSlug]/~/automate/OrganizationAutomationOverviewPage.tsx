...
const AUTOMATION_SURFACES = [
  {
    icon: Workflow,
    label: 'Workflows',
    path: APP_ROUTES.AUTOMATE.WORKFLOWS,
  },
  { icon: Cpu, label: 'Runs', path: APP_ROUTES.AUTOMATE.RUNS },
  {
    icon: MessageSquare,
    label: 'Autopilot',
    path: APP_ROUTES.AUTOMATE.AUTOPILOT,
  },
  {
    icon: ChartLine,
    label: 'Analytics',
  ...
  const brandCards: OrganizationAutomationBrand[] = useMemo(
    () =>
      brands.flatMap((brand) => {
        ...
        return [
          {
            href: createBrandAppRoute(orgSlug, slug, APP_ROUTES.AUTOMATE.ROOT),
            id,
