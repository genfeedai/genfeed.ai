...
const AUTOMATION_SURFACES = [
  {
    icon: Workflow,
    label: 'Workflows',
    path: APP_ROUTES.ORCHESTRATION.WORKFLOWS,
  },
  { icon: Cpu, label: 'Runs', path: APP_ROUTES.ORCHESTRATION.RUNS },
  {
    icon: MessageSquare,
    label: 'Autopilot',
    path: APP_ROUTES.ORCHESTRATION.AUTOPILOT,
  },
  {
    icon: ChartLine,
    label: 'Analytics',
    path: APP_ROUTES.ORCHESTRATION.ANALYTICS,
  },
] as const;
