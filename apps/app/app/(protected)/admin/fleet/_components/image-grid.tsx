...
export default function ImageGrid({
  ...
  const [lightboxAsset, setLightboxAsset] = useState<IFleetAsset | null>(null);
      ...
      >
        <DialogPortal>
          ...
          <DialogContent
            ...
            aria-label={lightboxAsset?.label || 'Fleet asset lightbox'}
          >
            <Button
              variant={ButtonVariant.UNSTYLED}
              withWrapper={false}
            ...
            {lightboxAsset && (
              <Image
                unoptimized
                alt={lightboxAsset.label || 'Fleet asset'}
