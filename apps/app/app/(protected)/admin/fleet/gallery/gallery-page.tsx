...
export default function GalleryPage() {
  ...
  const {
    ...
    queryKey: ['fleet-gallery-assets', selectedCharacter, contentRating],
    queryFn: async () => {
      const service = await getFleetService();
  ...
  useEffect(() => {
    if (assetsError) {
      logger.error('GET /admin/fleet/assets failed', assetsError);
    }
  }, [assetsError]);
  ...
  const handleDelete = useCallback(
    ...
    [getFleetService, notificationsService, refresh],
  );
