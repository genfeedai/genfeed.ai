...
export default function VoicesPage() {
  ...
  useEffect(() => {
    if (voicesError) {
      logger.error('GET /admin/fleet/voices failed', voicesError);
    }
  }, [voicesError]);
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      logger.error('POST /admin/fleet/voices/generate failed', error);
  ...
  return (
    ...
    >
      <WorkspaceSurface
        ...
        tone="muted"
        data-testid="fleet-voices-generate-surface"
      >
        <div className="p-6">
      ...
      <WorkspaceSurface
        ...
        tone="muted"
        data-testid="fleet-voices-results-surface"
      >
