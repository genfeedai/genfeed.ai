    ...
    <Card bodyClassName="gap-0 p-8" className="border-border bg-card">
      <div className="flex flex-wrap items-start justify-between gap-6">
        <div className="max-w-2xl">
          <Badge
            className="px-4 py-1 text-2xs font-black uppercase tracking-[0.24em] text-muted-foreground"
            variant="ghost"
          >
            <Sparkles className="size-3" />
            Prepared Before You Arrived
          </Badge>
          <h1 className="mt-5 text-4xl font-semibold leading-none tracking-tight text-foreground md:text-5xl text-balance">
