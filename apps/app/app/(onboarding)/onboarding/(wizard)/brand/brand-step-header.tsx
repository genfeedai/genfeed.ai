...
export default function BrandStepHeader() {
  return (
    <>
      <div className="step-badge opacity-0 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/60 text-2xs font-black uppercase tracking-[0.2em] mb-8">
