...
export const APP_MENU_ITEMS: MenuItemConfig[] = [
  ...
  {
    drillDown: true,
    group: AppMenuGroup.Lab,
    href: '/lab/articles',
    label: 'Articles',
    matchPaths: ['/lab/articles'],
    outline: HiOutlineDocumentText,
    solid: HiDocumentText,
  },
  {
    group: AppMenuGroup.Lab,
    href: '/lab/library-preview',
    label: 'Library Preview',
    matchPaths: ['/lab/library-preview'],
    outline: HiOutlineFolder,
    solid: HiFolder,
  },
  {
    ...
    href: '/lab/cron-jobs',
    label: 'Cron Jobs',
    matchPaths: ['/lab/cron-jobs'],
    outline: HiOutlineClock,
    solid: HiClock,
  },
  {
    group: AppMenuGroup.Lab,
    href: '/lab/twitter-engage',
    label: 'Twitter Engage',
    matchPaths: ['/lab/twitter-engage'],
    outline: HiOutlineSparkles,
    solid: HiSparkles,
  },
];
