...
function ModalComponent({
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div
        className={`fixed left-1/2 top-1/2 z-50 flex max-h-[90vh] w-[calc(100%-2rem)] ${maxWidth} -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-xl bg-card shadow-xl ${className ?? ''}`}
      >
        {showHeader && (
