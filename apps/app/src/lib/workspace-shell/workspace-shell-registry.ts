...
const BREADCRUMB_LEAF_OVERRIDES = Object.freeze({
  ...
  '/:orgSlug/:brandSlug/automate/reply-campaigns': 'Reply Campaigns',
  '/:orgSlug/:brandSlug/automate/author-replies': 'Author Replies',
...
const BRAND_ROUTE_REGISTRATIONS = [
  ...
  ...registerRoutes(
    [
      ...
      '/:orgSlug/:brandSlug/automate/author-replies',
