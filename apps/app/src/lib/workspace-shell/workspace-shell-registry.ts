...
const BREADCRUMB_LEAF_OVERRIDES = Object.freeze({
  ...
  '/:orgSlug/:brandSlug/posts/campaigns': 'Campaigns',
  '/:orgSlug/:brandSlug/posts/campaigns/new': 'New Campaign',
  '/:orgSlug/:brandSlug/posts/campaigns/:id': 'Campaign',
  '/:orgSlug/:brandSlug/posts/outreach-campaigns': 'Outreach',
  '/:orgSlug/:brandSlug/posts/outreach-campaigns/new': 'New Outreach Campaign',
  ...
  '/:orgSlug/:brandSlug/orchestration/workflows/new': 'New Workflow',
  '/:orgSlug/:brandSlug/orchestration/workflows': 'Workflows',
  '/:orgSlug/:brandSlug/orchestration/workflows/templates': 'Templates',
  '/:orgSlug/:brandSlug/orchestration/workflows/executions': 'Runs',
  '/:orgSlug/:brandSlug/orchestration/reply-campaigns': 'Reply Campaigns',
...
const BRAND_ROUTE_REGISTRATIONS = [
  ...
  ...registerRoutes(
    [
      ...
      '/:orgSlug/:brandSlug/posts/campaigns',
      '/:orgSlug/:brandSlug/posts/campaigns/new',
      '/:orgSlug/:brandSlug/posts/campaigns/:id',
      '/:orgSlug/:brandSlug/posts/newsletters',
      '/:orgSlug/:brandSlug/posts/outreach-campaigns',
      '/:orgSlug/:brandSlug/posts/outreach-campaigns/new',
      '/:orgSlug/:brandSlug/posts/outreach-campaigns/:id',
  ...
  ...registerRoutes(
    [
      ...
      '/:orgSlug/:brandSlug/orchestration/reply-campaigns',
  ...
  ...registerRoutes(
    ...
    {
      fallback: '/:orgSlug/:brandSlug/orchestration/workflows',
      mode: 'canvas',
      productClass: 'control-plane',
      scope: 'brand',
      surfaceKey: 'orchestration-workflows-editor',
      switcherItems: ['automate'],
      telemetryClass: 'product',
    },
  ),
