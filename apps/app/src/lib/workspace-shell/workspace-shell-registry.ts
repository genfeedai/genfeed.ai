...
const BREADCRUMB_LEAF_OVERRIDES = Object.freeze({
  ...
  '/:orgSlug/:brandSlug/automation/workflows/executions/:id': 'Run',
  ...
  '/:orgSlug/:brandSlug/automation/workflows/templates': 'Templates',
  '/:orgSlug/:brandSlug/automation/workflows/executions': 'Runs',
...
const BRAND_ROUTE_REGISTRATIONS = [
  ...
  ...registerRoutes(
    [
      ...
      '/:orgSlug/:brandSlug/automation/workflows/executions',
      '/:orgSlug/:brandSlug/automation/workflows/executions/:id',
    ],
    {
