...
<Callout type="info">
  **The math:** If you generate fewer than 500 images/month, Cloud is more cost-effective when you factor in
  infrastructure and maintenance time. Above 500/month, self-hosting saves money, but Publisher, Analytics,
  and multi-tenancy are not available in the self-hosted edition.
</Callout>
