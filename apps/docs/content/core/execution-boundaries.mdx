...
Cloud-only services do not run inside Community unless they are delivered in a
separate commercial artifact or called through an explicit Cloud API
integration. The published Community image excludes `ee/`.
