---
description: 'REST API documentation for genfeed.ai: Better Auth JWT authentication, plus endpoints for content generation, management, distribution, and analytics.'
---
...
**Authentication:** Better Auth bearer JWTs
