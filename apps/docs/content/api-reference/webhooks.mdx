---
title: Webhooks
description: Signed outbound webhook events for scheduled publish outcomes: endpoint configuration, delivery guarantees, the event catalog, and payload shape.
---
