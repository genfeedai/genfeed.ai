---
title: Webhooks
description: 'Configure and verify signed outbound Genfeed webhooks for publishing, generation, and workflow execution outcomes, including endpoints, secrets, retries, and payloads.'
---
