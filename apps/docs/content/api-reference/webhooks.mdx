---
title: Webhooks
description: 'Configure and verify signed outbound Genfeed webhooks for publishing, generation, and workflow outcomes: endpoints, secrets, retries, and payloads.'
---
