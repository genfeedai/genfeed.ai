---
description: 'Connect a TikTok account to Genfeed.ai to publish videos, covering account setup, upload requirements, and fixes for the most common upload failures.'
---
