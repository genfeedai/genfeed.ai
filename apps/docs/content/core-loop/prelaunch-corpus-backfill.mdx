---
description: 'The credential-free backfill that seeds a global prelaunch trend corpus, giving cold-start tenants prompt-ready examples before they connect accounts.'
---
