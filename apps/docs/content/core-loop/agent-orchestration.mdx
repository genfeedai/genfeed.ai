---
description: 'How Genfeed''s agent runtime is organised — orchestrator, threading, spawn, campaign, and workflow modules — and the V1 consolidation target for them.'
---
