---
description: 'Trace the Genfeed OSS analytics backbone from stored post metrics through content performance, business summaries, sync jobs, and dashboards.'
---
...
- Provider metric ingestion and publication analytics:
  ...
  - [`apps/server/server/src/collections/posts/services/post-analytics.service.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/collections/posts/services/post-analytics.service.ts)
...
- Content-performance feedback loop:
  ...
  - [`apps/server/server/src/collections/content-performance/services/performance-summary.service.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/collections/content-performance/services/performance-summary.service.ts)
  - [`apps/server/server/src/collections/content-performance/services/analytics-sync.service.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/collections/content-performance/services/analytics-sync.service.ts)
- Endpoint-level organization and brand analytics:
  ...
  - [`apps/server/server/src/endpoints/analytics/analytics.service.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/endpoints/analytics/analytics.service.ts)
...
- Thin consumers of the same analytics services:
  ...
  - [`apps/server/server/src/collections/agent-goals/services/agent-goals.service.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/collections/agent-goals/services/agent-goals.service.ts)
...
| Multi-tenant analytics governance             | SaaS/Enterprise boundary  | Cross-client reporting, audit controls, and commercial governance are not Community product surfaces; generic request/query guards remain in the public API.        |
