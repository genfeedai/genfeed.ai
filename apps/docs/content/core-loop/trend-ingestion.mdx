---
description: "Trace Genfeed's OSS trend-ingestion path through registered modules, cached and live fetches, normalized trend records, and focused smoke coverage."
---
...
- [`apps/server/server/src/collections/trends/services/trends.service.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/collections/trends/services/trends.service.ts)
...
- [`apps/server/server/src/collections/trends/services/trends.service.spec.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/collections/trends/services/trends.service.spec.ts)
- [`apps/server/server/src/collections/trends/services/modules/trend-fetch.service.spec.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/server/src/collections/trends/services/modules/trend-fetch.service.spec.ts)
