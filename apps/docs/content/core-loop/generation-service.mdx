---
description: 'The OSS v1 generation surface in Genfeed: batch generation entrypoints, the content generator service, and the provider packages behind them.'
---
...
- [`packages/agent/src/constants/agent-models.constant.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/packages/agent/src/constants/agent-models.constant.ts)
  - defines the curated OpenRouter text-model catalog
...
3. Model/provider selection is resolved from reviewed model records or the curated OpenRouter catalog.
