...
- [`packages/actions/src/registry/source/index.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/packages/actions/src/registry/source/index.ts)
  - defines the canonical agent-visible generation tools
- [`packages/actions/src/registry/tool-registry.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/packages/actions/src/registry/tool-registry.ts)
...
- [`packages/agent/src/hooks/use-agent-registry-models.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/packages/agent/src/hooks/use-agent-registry-models.ts)
  - filters reviewed text-model records for the shared agent model selector
