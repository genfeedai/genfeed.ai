...
- [`packages/agent/src/utils/agent-generation-setup.util.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/packages/agent/src/utils/agent-generation-setup.util.ts)
  - seeds default Unified Generation Setup values (aspect ratio, model, duration) for the Agent's `GenerationActionCard` review — image/video only, with no Studio Look or Prompt Enhance sourcing (#4672)
...
| Skill execution    | `apps/server/api/src/services/skill-executor/*`                                            | Runs content skills such as `image-generation` through immutable canonical workflows     |
...
- [`apps/server/api/src/services/skill-executor/skill-executor.service.spec.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/api/src/services/skill-executor/skill-executor.service.spec.ts) covers workflow dispatch
- [`apps/server/api/src/services/skill-executor/handlers/image-generation.handler.spec.ts`](https://github.com/genfeedai/genfeed.ai/blob/master/apps/server/api/src/services/skill-executor/handlers/image-generation.handler.spec.ts) covers the representative image path
