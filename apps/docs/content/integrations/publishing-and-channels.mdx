...
| `X_ADS`                 | X Ads                                                  | OAuth 2.0 (PKCE)           | Ads account access, campaign, and analytics operations  |
...
| --------------------- | -------------------------------------------------------------------------------------------------------------------- |
| YouTube               | `YOUTUBE_CLIENT_ID`, `YOUTUBE_CLIENT_SECRET`, `YOUTUBE_REDIRECT_URI`; optional `YOUTUBE_API_KEY`                     |
...
| X Ads                 | `X_ADS_CLIENT_ID`, `X_ADS_CLIENT_SECRET`, `X_ADS_REDIRECT_URI`                                                       |
...
| Google Ads            | `GOOGLE_ADS_CLIENT_ID`, `GOOGLE_ADS_CLIENT_SECRET`, `GOOGLE_ADS_DEVELOPER_TOKEN`, `GOOGLE_ADS_REDIRECT_URI`          |
| Google Search Console | `GOOGLE_SEARCH_CONSOLE_CLIENT_ID`, `GOOGLE_SEARCH_CONSOLE_CLIENT_SECRET`, `GOOGLE_SEARCH_CONSOLE_REDIRECT_URI`       |
