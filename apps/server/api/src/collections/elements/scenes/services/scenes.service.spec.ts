import type { CreateElementSceneDto } from '@api/collections/elements/scenes/dto/create-scene.dto';
...
describe('ElementsScenesService', () => {
  let service: ElementsScenesService;
  ...
  beforeEach(() => {
    ...
    service = new ElementsScenesService(MockModel as never, mockLoggerService);
  });
  ...
  describe('create', () => {
    it('should create a scene', async () => {
      const dto: CreateElementSceneDto = {
        key: 'indoor',
        label: 'Indoor',
      } as never;
