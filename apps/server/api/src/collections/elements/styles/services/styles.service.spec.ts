import type { CreateElementStyleDto } from '@api/collections/elements/styles/dto/create-style.dto';
...
describe('ElementsStylesService', () => {
  let service: ElementsStylesService;
  ...
  beforeEach(() => {
    ...
    service = new ElementsStylesService(MockModel as never, mockLoggerService);
  });
  ...
  describe('create', () => {
    it('should create a style', async () => {
      const dto: CreateElementStyleDto = {
        key: 'minimal',
        label: 'Minimal',
      } as never;
