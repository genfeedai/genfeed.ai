...
/**
 * Thread runtime services without the orchestrator HTTP module.
 * Orchestrator imports this; the fat threading module adds the controller.
 */
@Module({
  exports: [
    AgentThreadsModule,
...
export class AgentThreadingCoreModule {}
