import type {
  ...
  XAdsRepositoryReadinessBlocker,
 ...
 */
@Injectable()
export class XAdsRepositoryExportService {
  constructor(
  ...
  getReadiness(): XAdsRepositoryReadiness {
    const blockers: XAdsRepositoryReadinessBlocker[] = [];
  ...
  async createExportReport(): Promise<never> {
