import { BeehiivProviderError as LegacyBeehiivProviderError } from '@server/services/integrations/beehiiv/errors/beehiiv-provider.error';
import type { BeehiivCreatePostInput as LegacyBeehiivCreatePostInput } from '@server/services/integrations/beehiiv/interfaces/beehiiv.interface';
import { BeehiivService as LegacyBeehiivService } from '@server/services/integrations/beehiiv/services/beehiiv.service';
