...
import type { BatchContentService } from '@server/services/batch-content/batch-content.service';
import type { CreateBatchContentDto } from '@api/services/batch-content/dto/create-batch-content.dto';
import type { BatchStatus } from '@server/services/batch-content/interfaces/batch-content.interfaces';
