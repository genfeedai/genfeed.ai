...
import type { CreateIngredientDto } from '@server/collections/ingredients/dto/create-ingredient.dto';
import type { IngredientDocument } from '@server/collections/ingredients/schemas/ingredient.schema';
import { IngredientsService } from '@server/collections/ingredients/services/ingredients.service';
import type { CreateMetadataDto } from '@server/collections/metadata/dto/create-metadata.dto';
...
import type {
  ...
  MediaDocumentsInput,
} from '@server/shared/services/shared/media-documents.types';
import {
  IngredientCategory,
  IngredientStatus,
  MetadataExtension,
