import type { IPromptBuilder } from '@server/services/prompt-builder/interfaces/prompt-builder.interface';
import type { PromptBuilderParams } from '@server/services/prompt-builder/interfaces/prompt-builder-params.interface';
import type { ReplicateInput } from '@server/services/prompt-builder/interfaces/replicate-input.interface';
