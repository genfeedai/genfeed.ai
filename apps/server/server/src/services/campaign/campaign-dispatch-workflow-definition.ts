...
import { CAMPAIGN_DM_BATCH_WORKFLOW_ID } from '@server/services/campaign/campaign-dm-workflow-definition';
import { CAMPAIGN_REPLY_BATCH_WORKFLOW_ID } from '@server/services/campaign/campaign-reply-workflow-definition';
