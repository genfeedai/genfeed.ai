...
} from '@server/endpoints/analytics/analytics-response.projection';
...
export type { AnalyticsBestPostingTime } from '@server/endpoints/analytics/analytics-response.projection';
