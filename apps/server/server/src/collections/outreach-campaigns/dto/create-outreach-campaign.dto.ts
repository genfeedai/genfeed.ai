import { OutreachCampaignAiConfigDto } from '@server/collections/outreach-campaigns/dto/outreach-campaign-ai-config.dto';
import { OutreachCampaignDiscoveryConfigDto } from '@server/collections/outreach-campaigns/dto/outreach-campaign-discovery-config.dto';
import { OutreachCampaignDmConfigDto } from '@server/collections/outreach-campaigns/dto/outreach-campaign-dm-config.dto';
import { OutreachCampaignRateLimitsDto } from '@server/collections/outreach-campaigns/dto/outreach-campaign-rate-limits.dto';
import { OutreachCampaignScheduleDto } from '@server/collections/outreach-campaigns/dto/outreach-campaign-schedule.dto';
