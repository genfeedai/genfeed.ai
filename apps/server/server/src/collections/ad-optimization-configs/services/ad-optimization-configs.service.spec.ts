import type { PrismaAdOptimizationConfig } from '@server/collections/ad-optimization-configs/schemas/ad-optimization-config.schema';
import { DEFAULT_AD_OPTIMIZATION_CONFIG } from '@server/collections/ad-optimization-configs/schemas/ad-optimization-config.schema';
