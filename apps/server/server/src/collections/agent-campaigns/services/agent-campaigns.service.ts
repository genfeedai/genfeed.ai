import { CreateAgentCampaignDto } from '@server/collections/agent-campaigns/dto/create-agent-campaign.dto';
import { CreateAgentCampaignFromTemplateDto } from '@server/collections/agent-campaigns/dto/create-agent-campaign-from-template.dto';
import { UpdateAgentCampaignDto } from '@server/collections/agent-campaigns/dto/update-agent-campaign.dto';
...
} from '@server/collections/agent-strategies/services/agent-strategies.service';
