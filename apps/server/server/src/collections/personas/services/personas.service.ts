import { CreatePersonaDto } from '@server/collections/personas/dto/create-persona.dto';
import { UpdatePersonaDto } from '@server/collections/personas/dto/update-persona.dto';
...
import type { PrismaUpdate } from '@server/shared/services/base/base-query-normalization.adapter';
