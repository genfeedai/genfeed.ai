import { CreateContentPlanDto } from '@server/collections/content-plans/dto/create-content-plan.dto';
import { UpdateContentPlanDto } from '@server/collections/content-plans/dto/update-content-plan.dto';
import type { ContentPlanDocument } from '@server/collections/content-plans/schemas/content-plan.schema';
import {
  asDate,
  asNumber,
  asRecord,
  asString,
  serializeDate,
} from '@server/collections/content-plans/utils/content-plan-data.util';
