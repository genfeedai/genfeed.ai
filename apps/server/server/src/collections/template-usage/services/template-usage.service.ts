import { TemplateUsageEntity } from '@server/collections/template-usage/entities/template-usage.entity';
import type { TemplateUsageDocument } from '@server/collections/template-usage/schemas/template-usage.schema';
