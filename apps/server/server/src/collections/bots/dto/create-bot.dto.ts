import { BotEngagementSettingsDto } from '@server/collections/bots/dto/bot-engagement-settings.dto';
import { BotLivestreamSettingsDto } from '@server/collections/bots/dto/bot-livestream-settings.dto';
import { BotMonitoringSettingsDto } from '@server/collections/bots/dto/bot-monitoring-settings.dto';
import { BotPublishingSettingsDto } from '@server/collections/bots/dto/bot-publishing-settings.dto';
import { BotSettingsDto } from '@server/collections/bots/dto/bot-settings.dto';
import { BotTargetDto } from '@server/collections/bots/dto/bot-target.dto';
