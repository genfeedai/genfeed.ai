import type { TrendSourceItem } from '@server/collections/trends/interfaces/trend.interfaces';
import type {
  SyncTrendReferenceInput,
  TrendReferenceRecordData,
} from '@server/collections/trends/services/trend-reference-corpus.types';
import { getTrendEngagementTotal } from '@server/collections/trends/utils/trend-engagement.util';
