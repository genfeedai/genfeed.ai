import { CreateCampaignTargetDto } from '@server/collections/campaign-targets/dto/create-campaign-target.dto';
import { UpdateCampaignTargetDto } from '@server/collections/campaign-targets/dto/update-campaign-target.dto';
...
} from '@server/collections/campaign-targets/services/campaign-target-json.util';
...
import type { PrismaFilter } from '@server/shared/services/base/base-query-normalization.adapter';
