...
import type { ArticleAnalyticsDocument } from '@server/collections/articles/schemas/article-analytics.schema';
import {
  normalizePerformanceMetrics,
  type PerformanceMetricsInput,
} from '@server/collections/articles/utils/virality-analysis.mapper';
