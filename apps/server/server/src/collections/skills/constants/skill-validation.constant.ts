import { loadFirstPartySkillIdentities } from '@server/collections/skills/catalog/first-party-skill-loader';
import {
  type BuiltInSkillIdentity,
  mergeBuiltInSkillCatalog,
  ORIGINAL_BUILT_IN_SKILL_CATALOG,
} from '@server/collections/skills/constants/skill-catalog-identity';

export const MAX_CONFIGURED_SKILL_SLUGS = 100;
export const MAX_SKILL_SLUG_LENGTH = 160;

export type { BuiltInSkillIdentity } from '@server/collections/skills/constants/skill-catalog-identity';
export {
