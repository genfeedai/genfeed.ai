...
import { CreatePostAnalyticsDto } from '@server/collections/posts/dto/create-post-analytics.dto';
...
import type { PostAnalyticsDocument } from '@server/collections/posts/schemas/post-analytics.schema';
