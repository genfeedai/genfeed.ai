import type { CreatePlaybookDto } from '@server/collections/content-intelligence/dto/create-playbook.dto';
import type { PatternPlaybookDocument } from '@server/collections/content-intelligence/schemas/pattern-playbook.schema';
