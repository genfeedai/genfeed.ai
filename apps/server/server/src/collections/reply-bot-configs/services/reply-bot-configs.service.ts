...
import type { ReplyBotRateLimitsDto } from '@server/collections/reply-bot-configs/dto/reply-bot-rate-limits.dto';
...
import type {
  ...
  ReplyBotRateLimits,
} from '@server/collections/reply-bot-configs/schemas/reply-bot-config.schema';
