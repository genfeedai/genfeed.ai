import type { CreateTaskDto } from '@server/collections/tasks/dto/create-task.dto';
...
import type { PendingReviewGateState } from '@server/collections/workflows/services/workflow-executor.types';
