...
import { createVitestWarningLogger, installVitestWarningFilter, } from '../configs/vitest-warning-filter';
    ...
    resolve: {
        alias: [
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/constants/src/index.ts'),
            },
            {
                find: /^@genfeedai\/constants\/(.*)$/,
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/desktop-contracts/src/index.ts'),
            },
            {
                find: /^@genfeedai\/desktop-contracts\/(.*)$/,
                replacement: path.resolve(repoRoot, './packages/desktop-contracts/src/$1'),
            },
            {
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/interfaces/src/index.ts'),
            },
            {
                find: /^@genfeedai\/interfaces\/(.*)$/,
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/serializers/src/index.ts'),
            },
            {
                find: /^@genfeedai\/serializers\/(.*)$/,
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/workflow-saas/src/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-saas\/(.*)$/,
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/canvas$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/canvas/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/hooks$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/hooks/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/lib$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/lib/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/nodes$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/nodes/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/panels$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/panels/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/provider$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/provider/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/stores$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/stores/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/toolbar$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/toolbar/index.ts'),
            },
            {
                find: /^@genfeedai\/workflow-ui\/ui$/,
                replacement: path.resolve(repoRoot, './packages/workflow-ui/src/ui/index.ts'),
            },
            {
                find: /^@workflow-saas$/,
                replacement: path.resolve(repoRoot, './packages/workflow-saas/src/index.ts'),
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/pages/not-found/not-found-page.tsx'),
            },
            {
                find: /^@pages\/(.*)$/,
            ...
            ...(hasLocalUiRoot
                ? [
                    ...
                    },
                    {
                        ...
                        replacement: path.resolve(localUiRoot, './marketing/PricingStrip.tsx'),
                    },
                    {
            ...
            {
                find: /^@ui\/primitives\/(.*)$/,
                replacement: path.resolve(__dirname, '../packages/ui/src/primitives/$1'),
            },
            {
                find: /^@props$/,
            ...
            },
            {
                ...
                replacement: path.resolve(repoRoot, './packages/ui/src/modals/compound'),
            },
            {
                find: /^@ui\/modals\/compound\/(.*)$/,
                replacement: path.resolve(repoRoot, './packages/ui/src/modals/compound/$1'),
            },
            {
                find: /^@ui\/charts$/,
            ...
            {
                find: /^@ui-constants$/,
                replacement: path.resolve(repoRoot, './packages/ui/src/components/constants'),
            },
            {
                find: /^@ui-constants\/(.*)$/,
                replacement: path.resolve(repoRoot, './packages/ui/src/components/constants/$1'),
            },
            {
                find: /^@utils$/,
