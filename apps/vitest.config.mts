...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      {
        find: /^@app-tests$/,
        replacement: path.resolve(appRoot, './tests'),
      },
      {
        find: /^@app-tests\/(.*)$/,
      ...
      },
      {
        ...
        replacement: path.resolve(repoRoot, './packages/actions/src/index.ts'),
      },
      {
      ...
      // (matches the primitives/generators/dashboard/core/semantic pattern).
      {
        find: /^@ui\/utils$/,
      ...
      {
        find: /^@ui\/tokens$/,
        replacement: path.resolve(repoRoot, './packages/ui/src/tokens'),
      },
      {
        find: /^@ui\/tokens\/(.*)$/,
        replacement: path.resolve(repoRoot, './packages/ui/src/tokens/$1'),
      },
      {
        find: /^@ui\/components\/(.*)$/,
