...
Analytics ingestion awaits refresh after its durable metric write. Source collection
awaits refresh after its account batch is stored. A refresh failure propagates to the
...
Reads are paginated at 200 rows, with a hard 10000-record account history limit.
