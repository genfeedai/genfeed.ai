...
- [ADR-CONVERSATION-SHELL-CONTRACTS](architecture/ADR-CONVERSATION-SHELL-CONTRACTS.md) — v3.1: conversation is a surface (own route + inspector), composer follows it, permanent frame and module-owned nav column
