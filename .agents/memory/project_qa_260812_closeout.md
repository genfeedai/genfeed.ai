...
- Standing project rules: `feedback_qa_queue_branch_protocol.md`, `feedback_tdd_first.md` (via MEMORY.md). Personal multi-host fleet notes: gitignored `.agents/memory/local/` and global user memory.
